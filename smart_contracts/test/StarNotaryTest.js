...
contract('StarNotary', accounts => {
    ...
    describe('Check if star exist in Smart Contract', () => {
        ...
        it('Check if star is already assigned', async () => {
            //const result = await this.contract.checkIfStarExist(hashStarTokenId1, {from: user1});
            const result = await this.contract.checkIfStarExist(starData1.ra, starData1.dec, starData1.mag, {from: user1});
